...
## change class1 to class2 in em 
res4$em_class[which(res4$em_class == 2)]=0
res4$em_class[which(res4$em_class == 1)]=2
res4$em_class[which(res4$em_class == 0)]=1

res5 = clusters$centers %>% 
  as.data.frame()

mean_value = rbind(res3,res5) %>% 
